  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex flex-wrap w-full">
      ...
      <div class="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12">
        ...
        <div class="mb-4 text-center">
          <button class="bg-indigo-500 text-white px-4 py-2 rounded-md"
            onclick="window.location.href='generate-event-report-form'">
        ...
        <div class="relative">
          ...
          <button id="nextBtn"
            class="absolute top-1/2 right-0 transform -translate-y-1/2 bg-gray-300 text-gray px-4 py-2 rounded-r-md">
            Next
          </button>
        </div>
      </div>
...
<script>
  ...
  const images = ["img/r1.jpg", "img/r2.jpg", "img/r3.jpg", "img/r4.jpg", "img/r5.jpg", "img/r6.jpg", "img/r7.jpg",
    "img/r8.jpg", "img/r9.jpg", "img/r10.jpg", "img/r11.jpg", "img/r12.jpg", "img/r13.jpg", "img/r14.jpg",
    "img/r15.jpg", "img/r16.jpg", "img/r17.jpg", "img/r18.jpg", "img/r19.jpg", "img/r20.jpg", "img/r21.jpg",
    "img/r22.jpg"
