              ...
              <div
                ...
                <div
                  ...
                  <div class="sm:col-span-12">
                      ...
                      Description Report (ADMIN and user SIDE)
                    </h2>
                  </div>
                  <!-- End Col -->
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:flex">
                      <input type="text" id="r_purpose" name="r_purpose"
                        value="{{ old('r_purpose', $eventReportData->r_purpose) }}"
                  ...
                  <div class="sm:col-span-9">
                    ...
                    <div class="sm:col-span-9">
                      <textarea id="r_background" name="r_background"
                        ...
                        rows="6" @if (auth()->user()->role == 'admin') readonly @endif>{{ old('r_background', $eventReportData->r_background) }}
                        </textarea>
                  ...
                  <!-- <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="r_description_Comment" name="r_description_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="6" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('r_description_Comment', $eventReportData->r_description_Comment) }}
                        </textarea>
