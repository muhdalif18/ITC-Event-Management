          ...
          <tbody>
            @foreach ($eventReport as $eventReportData)
              <tr
                ...
                <td class="px-6 py-4">
                  <div class={{ $eventReportData->organizer_exco }}>
                    {{ $eventReportData->organizer_exco }}
                  </div>
                </td>

                <td class="px-6 py-4">
                  <div class={{ $eventReportData->organizer_exco }}>
                    {{ $eventReportData->event_director }}
                  </div>
                </td>
                      ...
                      <form method="POST"
                        ...
                        <select name="status" onchange="this.form.submit()"
                          ...
                          <option value="Not Approved"
                            {{ $eventReportData->status == 'Not Approved' ? 'selected' : '' }}>Not
                            Approved</option>
                        </select>
                      </form>
                    </div>
