    ...
    <div class="p-6 text-gray-900">
      ...
      <div data-hs-stepper>
        ...
        <div class="mt-5 sm:mt-8 ">
          <form id="event-proposal-form"
            method='post'action={{ route('event.patch-event-proposal', $eventProposalData->id) }}>
            @csrf
            @method('patch')
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="description_Comment" name="description_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('description_Comment', $eventProposalData->description_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="organizer_Comment" name="organizer_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('organizer_Comment', $eventProposalData->organizer_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="eventDetails_Comment" name="eventDetails_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('eventDetails_Comment', $eventProposalData->eventDetails_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="obj_Comment" name="obj_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('obj_Comment', $eventProposalData->obj_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="participant_escorts_Comment" name="participant_escorts_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('participant_escorts_Comment', $eventProposalData->participant_escorts_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="suggested_role_Comment" name="suggested_role_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('suggested_role_Comment', $eventProposalData->suggested_role_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="impact_student_Comment" name="impact_student_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('impact_student_Comment', $eventProposalData->impact_student_Comment) }}
                    </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="tentative_activity_Comment" name="tentative_activity_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('tentative_activity_Comment', $eventProposalData->tentative_activity_Comment) }}
                      </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="committee_Comment" name="committee_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('committee_Comment', $eventProposalData->committee_Comment) }}
                    </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="others_Comment" name="others_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('others_Comment', $eventProposalData->others_Comment) }}
                    </textarea>
                  ...
                  <div class="sm:col-span-9">
                    <div class="sm:col-span-9">
                      <textarea id="implication_Comment" name="implication_Comment"
                        class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('implication_Comment', $eventProposalData->implication_Comment) }}
                                      </textarea>
                ...
                <div class="sm:col-span-9">
                  <div class="sm:col-span-9">
                    <textarea id="decision_Comment" name="decision_Comment"
                      class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                      rows="3" @if (auth()->user()->role != 'admin') readonly @endif>{{ old('decision_Comment', $eventProposalData->decision_Comment) }}
                                      </textarea>
          ...
          <script>
            document.querySelectorAll('.downloadWordBtn').forEach(button => {
              button.addEventListener('click', function() {
                ...
                window.location.href = `/export-to-word-report/${proposalId}`;
              });
            });
          </script>
